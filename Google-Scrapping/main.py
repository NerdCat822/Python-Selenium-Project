...
class GoogleKeywordScreenshooter:
    def __init__(self, keyword, screenshots_dir, max_page=2):
        ...
        def screenshot_bot(search_results, page_num):
            for index, search_result in enumerate(search_results):
                search_result.screenshot(
                    f"{self.screenshots_dir}/{page_num}-{self.keyword}x{index}.png")
...
domain_competitors = GoogleKeywordScreenshooter(
    "buy domain", "Google-Scrapping/screenshots")
domain_competitors.start()
domain_competitors.finish()


python_competitors = GoogleKeywordScreenshooter(
    "python book", "Google-Scrapping/screenshots")
